    ...
    <header className='border-b border-zinc-800 p-4 items-center justify-between bg-zinc-900/30'>
      <div className="flex items-center gap-4">
        ...
        <div className='flex flex-col'>
          ...
          <span className={`text-sm font-bold flex items-center gap-2 ${timeRemainig !== null && timeRemainig < 60 ? 'text-red-500' : 'text-amber-500'}`}>
            {timeRemainig !== null ? formatTiming(timeRemainig) : '--:--'}
          </span>
        </div>
      </div>
